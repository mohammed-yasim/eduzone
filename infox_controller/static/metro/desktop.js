...
function Pull(){
    Desktop.createWindow({
        ...
        onShow:function(win){
            console.log(win);
            var win = $(win);
             win.children(".window-content").load('/infox/pull');
        }
    });
}
function Restart(){
    Desktop.createWindow({
        ...
        onShow:function(win){
            console.log(win);
            var win = $(win);
             win.children(".window-content").load('/infox/refresh');
        }
    });
}
function Collect(){
    Desktop.createWindow({
        ...
        onShow:function(win){
            console.log(win);
            var win = $(win);
             win.children(".window-content").load('/infox/collectstatic');
        }
    });
}
